...
const BASE: Omit<PersonalFact, "createdAt" | "updatedAt" | "approved">[] = [
  ...
  { id: "village", fact: "Ancestral village: Daudpur (দাউদপুর), Word 3, Balarhat Union (বালারহাট ইউনিয়ন), Mithapukur Upazila, Rangpur.", category: "Roots", source: "explicit: user", confidence: 1, status: "APPROVED", keywords: ["daudpur", "dawdpur", "balarhat", "mithapukur", "village", "গ্রাম", "মিঠাপুকুর", "দাউদপুর", "বালারহাট"] },

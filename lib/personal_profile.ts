...
const PROFILE: PersonalFact[] = [
  ...
  { id: "birthplace", category: "Birthplace",
    ...
    content: "MD Rayhan Mia was born in Dhaka, Bangladesh, and grew up in Dhaka. His ancestral village is Daudpur (দাউদপুর), Word No. 3, Balarhat Union (বালারহাট ইউনিয়ন), Mithapukur Upazila, Rangpur." },
  ...
  { id: "location", category: "Bangladesh roots",
    keywords: ["rangpur", "mithapukur", "balarhat", "daudpur", "dawdpur", "রংপুর", "মিঠাপুকুর", "দাউদপুর", "বালারহাট"],
    content: "MD Rayhan Mia currently lives in Rangpur, Bangladesh. His village is Daudpur (দাউদপুর), Word No. 3, Balarhat Union (বালারহাট ইউনিয়ন), Mithapukur Upazila." },

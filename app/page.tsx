    ...
    return (
      <div className="auth-wrap">
        <div className="auth-card">
          ...
          {(oauth.google || oauth.github || oauth.facebook) && (
            <>
              <div className="auth-divider"><span>or continue with</span></div>
              <div className="social-btns">
                {oauth.google && (
                  <button className="social-btn google" onClick={() => oauthLogin("google")}>
                ...
                {oauth.github && (
                  <button className="social-btn github" onClick={() => oauthLogin("github")}>
                ...
                {oauth.facebook && (
                  <button className="social-btn facebook" onClick={() => oauthLogin("facebook")}>
